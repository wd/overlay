...
TS=1402921811
SRC_URI="amd64? (
http://download.ime.sogou.com/${TS}/sogou_pinyin_linux_${PV}_amd64.deb -> ${P}_amd64.deb )
x86? ( http://download.ime.sogou.com/${TS}/sogou_pinyin_linux_${PV}_i386.deb -> ${P}_i386.deb )"
...
src_install(){
	...
	doins -r ${S}/usr/share/sogou-qimpanel
